...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/car/list/{state?}', [CarController::class, 'listar'])->name('car.list');
    Route::get('/car/editar/{id}/{message?}', [CarController::class, 'editarCar'])->name('car.editar');
    Route::post('/car/actualizar/{id}', [CarController::class, 'actualizar'])->name('car.actualizar');
    Route::get('/car/allcars', [CarController::class, 'allcars']);
    Route::resource('/car', CarController::class);
    Route::post('/calendar/registrarcita', [CalendarController::class, 'registrarcita']);
    Route::post('/configcalendar/updatehorario', [CalendarController::class, 'updateHorario']);
    Route::resource('/calendar', CalendarController::class);
    Route::post('/profesionales/editar', [ProfesionalesController::class, 'editarProfesional']);
    Route::post('/profesionales/eliminar', [ProfesionalesController::class, 'eliminarProfesional']);
    Route::post('/profesionales/habilitar', [ProfesionalesController::class, 'habilitarProfesionales']);
